...
Example of a new network service-net which is a network used for service-chaining between VMs (not attached to physical ports). This network is attached to bridge `virbr1`:
